...
def get_youtube_handler(options):
    ...
    default_credentials = os.path.join(home, "youtubeCollage", ".youtube-upload-credentials.json")
    client_secrets = options.client_secrets or os.path.join(home, "youtubeCollage", ".client_secrets.json")
